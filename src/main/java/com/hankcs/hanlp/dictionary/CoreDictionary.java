...
public class CoreDictionary {
	...
	/**
	 * merge custom dictionary into core dictionary
	 *
...
//        public static Attribute NUMBER = new Attribute()
		...
		/**
		 * merge another attribute into this
		 * if Attribute.Nature are same, original frequency will be replaced by new frequency
		 *
		 * @param attr
		 */
